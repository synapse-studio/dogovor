...
Вознаграждение не выплачивается за лиды, являющиеся связанными с текущими клиентами компании, в том числе которые:

- имеют общих учредителей, владельцев или представителей с партнёром или другими клиентами компании;
- являются филиалами, дочерними организациями, подрядчиками, партнёрами или иными структурами, аффилированными с основной компанией клиента;
- зарегистрированы под тем же юридическим лицом, ИП, либо ведут деятельность под тем же брендом, торговым названием или доменным именем.

Компания оставляет за собой право самостоятельно устанавливать факт аффилированности или родственной связи между новым клиентом и тем, кто его порекомендовал, и при подтверждении такого факта, отказывать в выплате вознаграждения.
