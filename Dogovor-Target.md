...
* 1.3. Рекламодатель — лицо, заинтересованное в привлечении посетителей 
  на свой сайт путем размещения рекламы в ВКонтакте и MyTarget. 
...
* 1.5. Ключевой запрос – слово или словосочетание, используемое в рекламной 
  кампании в ВКонтакте и MyTarget, при запросе которого 
...
* 1.7. Группа рекламных кампаний – совокупность заказанных 
  ...
  рекламных кампаний, в ВКонтакте и MyTarget, 
  направленных на продвижение одного продукта (товара или услуги) 
  или группы схожих продуктов и ведущих на один сайт/группу в 
  социальных сетях.
  
* 1.8. Показ – появление объявлений на страницах в социальной сети 
  ВКонтакте и на проектах Mail.ru Group и в 
...
* 1.17. Отчет – сведения, предоставляемые Исполнителем по запросу 
  ...
  кампаниям в ВКонтакте и MyTarget.
...
* 2.1. Исполнитель обязуется на основании брифа и заявок Заказчика 
  ...
  (или) услуг Заказчика в ВКонтакте и MyTarget, 
  ...
  - 2.1.2. Управление группой рекламных кампаний в ВКонтакте и MyTarget.

* 2.2. Аудитория для таргетинга, срок начала размещения таргетированной рекламы,
  и иные параметры размещения обсуждаются Сторонами на моменте брифования.
  При этом Заказчик имеет право внести правки в запущенную рекламную
  кампанию, но не более 3-х раз.
...
* 5.1. Исполнитель обязан:
  ...
  месяце, на условиях, определенных в п. 7 настоящего Договора.
...
* 5.2. Заказчик обязан:
  ...
  - 5.2.6. Самостоятельно заполнить Бриф по форме Исполнителя и направить 
   его Исполнителю;
...
## 6. Стоимость услуг и порядок расчетов при размещении рекламы на площадках социальных сетей Mytarget и Вконтакте

* 6.1. Стоимость услуг по настройке и сопровождению одной группы 
  рекламных кампаний Заказчика определяется Исполнителем. 

* 6.2. Стоимость услуг за календарный месяц является фиксированной 
...
* 7.1. Договор начинает свое действие с момента оплаты первого счета и 
  действует до окончания календарного года.

* 7.2. Если ни одна из сторон не заявит в письменном виде о прекращении 
  действия Договора до 25 декабря текущего года, он автоматически 
  пролонгируется на каждый следующий календарный год.

* 7.3. Исполнитель оставляет за собой право внести изменения в условия 
...
* 7.5. Заказчик вправе в одностороннем порядке расторгнуть настоящий договор, 
...
* 7.6. Досрочное расторжение Договора может иметь место по соглашению сторон 
  либо по основаниям, предусмотренным действующим на территории 
  Российской Федерации гражданским законодательством.

* 7.7. При нарушении одной из Сторон условий настоящего Договора другая 
...
* 7.8. В случае установления нецелесообразности или невозможности 
...
* 11.1. Стороны освобождаются от ответственности за невыполнение 
...
* 12.1. При исполнении своих обязательств по настоящему Договору Стороны, 
...
* 12.3. Сторона, получившая уведомление о нарушении каких-либо положений данного 
...
* 12.4. В случае подтверждения факта нарушения одной Стороной положений данного 
...
## 13. Порядок работы с ОРД и/или ЕРИР во исполнении ФЗ№347 "О рекламе"

  * 13.1. Исполнитель обязуется самостоятельно определить ОРД 
    для исполнения Федерального закона от 02.07.2021 года 
    № 347-ФЗ "О внесении изменений в Федеральный закон "О рекламе".

  * 13.2. Исполнитель обязуется и имеет право передавать ОРД 
  ...
  * 13.3. Исполнитель имеет право запрашивать информацию у Заказчика, 
  ...
  * 13.4. В случае непередачи информации Заказчиком в срок, Исполнитель 
    вправе увеличить срок выполнения работ (оказания услуг) соразмерно 
    сроку просрочки без применения санкций к Исполнителю.

  * 13.5. Стороны пришли к соглашению, что передача данных, указанных 
  ...
  * 13.6. Исполнитель несет ответственность в рамках Федерального закона 
