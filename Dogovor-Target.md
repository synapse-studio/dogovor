...
* 2.1. Исполнитель обязуется на основании брифа и заявок Заказчика 
  ...
  - 2.1.1. Подготовка и размещение текстовых Рекламных объявлений в
    системе «VK Реклама»;
  - 2.1.2. Управление рекламными кампаниями в системе «VK Реклама».
...
* 2.2. Цели рекламной кампании, регионы показа объявлений, продвигаемые
  ...
  на моменте брифования. При этом Заказчик имеет право внести правки в 
...
* 4.4. При этом одна группа рекламных объявлений в системе «VK Реклама»:
  ...
  - 4.4.2. ведет на один сайт или на одну группу в социальных сетях, или на лид-форму;
...
* 4.8. Исполнитель предоставляет Заказчику доступ к рекламному кабинету в системе
  «VK Реклама».Заказчик обязуется создать новый аккаунт в системе «VK Реклама»
...
* 4.9. Исполнитель не несёт ответственности в случае использования 
  логина и пароля аккаунта Заказчика третьими лицами. Заказчик 
...
* 5.2. Заказчик обязан:
  ...
  индивидуализации. Исполнитель освобождается от проверки соблюдения Заказчиком 
...
- 5.3.7. Заказчик гарантирует наличие необходимых соглашений с правообладателями
  ...
  в отношении любых текстов, шрифтов, изображений и файлов, размещенных на Web-сайте и в рекламных объявлениях.
  ...
  размещенные на Web-сайте и в рекламных объявлениях размещены на законных основаниях и Заказчик имеет на руках
  ...
  изображений и любых файлов на Web-сайте и в рекламных объявлениях. Также Заказчик несет ответственность
  за контроль соблюдения сроков использования текстов, шрифтов, изображений и
  любых файлов на Web-сайте и в рекламных объявлениях, если такие сроки установлены подтверждающими документами.
...
* 6.1. Стоимость услуг по настройке и сопровождению одной группы 
  рекламных кампаний Заказчика определяется Исполнителем в рамках одного из тарифов, которые
  опубликованы по адресу: https://www.synapse-studio.ru/product/vk-reklama-tarif-bazovyy-abonentskaya.
...
* 6.3. В случае если фактический объём работ превышает объем, предусмотренный 
...
* 6.6. Заказчик самостоятельно через личный кабинет отслеживает остаток 
  ...
  кампании, возникшее в связи с недостаточностью средств в бюджете рекламной 
...
* 6.10. Заказчик несет ответственность за правильность производимых им 
  ...
  опубликования новых на веб-сервере Исполнителя (https://www.synapse-studio.ru/doc), Заказчик 
...
* 7.1. Исполнитель размещает и запускает рекламную кампанию в течение
  трех рабочих дней с момента согласования Брифа и поступления денежных средств
  на счет Исполнителя.
...
* 7.5. Заказчик вправе приостановить действие настоящего договора, направив 
  соответствующее письменное уведомление Исполнителю. При этом  оказание по
  настоящему договору услуг приостанавливается с последнего дня месяца, 
...
## 11. Порядок работы с ОРД и/или ЕРИР во исполнении ФЗ№347 "О рекламе"
  ...
  * 11.5. Стороны пришли к соглашению, что передача данных, указанных 
    в настоящем Разделе, не относится и не будет относиться к конфиденциальной 
