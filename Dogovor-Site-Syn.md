...
* Наполнение страницы сайта - размещение на ней до 1000 знаков текста и до
  30 фотографий в формате .jpg без какого-либо форматирования. Все
  информационные материалы, предназначенные для размещения на сайте,
  предоставляются Заказчиком в электронном виде, в одном из следующих форматов:
  для текстов – форматы .doc, .docx, .odt; для фотографий: .jpg, .png.
...
услуг, а также сроком их оказания, указанным в пункте 4.1.1 настоящего договора.
  ...
  - 2.2.6. Исполнитель на основании информации, полученной от Заказчика, заполняет
    ...
    Исполнителю согласованный Бриф, а также информацию, файлы и изображения, которые
    необходимо разместить на Web-сайте. Заказчик вправе направить информацию, файлы и
    изображения после направления Брифа, однако Исполнитель в таком случае вправе
    увеличить срок исполнения работ по настоящему договору на период просрочки Заказчиком
    предоставления информации, файлов и изображений.
  ...
  - 2.2.7. Исполнитель публикует тестовую версию сайта и осуществляет наполнение сайта
    ...
    Услуги по подбору и приобретению текстов, шрифтов, файлов и изображений оплачиваются
    в соответствии с прейскурантом Исполнителя, действующим на момент приобретения таких
    изображений. При этом Заказчик обязуется оплатить стоимость самих текстов, шрифтов,
  ...
  - 2.2.10. После письменного утверждения на электронную почту Исполнителя или
    путем направления сообщения в мессенджерах Заказчиком тестовой версии сайта,
    Исполнитель подключает к сайту выбранный или предоставленный Заказчиком домен
    (1-3 рабочих дня при условии заполнения Заказчиком анкеты и/или предоставления
    необходимых документов) и размещает сайт в сети Интернет.
  ...
  - 2.2.12. Исполнитель регистрирует сайт Заказчика в поисковых системах Yandex.
    Регистрация подразумевает отправку запроса на индексацию сайта указанными поисковыми
    системами, при этом сам процесс индексации находится вне ведения Исполнителя и
    зависит от текстового наполнения сайта и иных требований фильтров поисковых систем.
    Исполнитель устанавливает счетчики Яндекс.Метрики без настройки целей.
...
предоставляемых услуг согласуются Сторонами в счете на предварительную оплату.
  ...
  - 4.1.2. По завершению работ направить Заказчику акт приемки-передачи оказанных
    ...
    Брифе. Не позднее 10-ти рабочих дней с момента направления Заказчику Акта
    приемки-передачи оказанных услуг в электронном виде, направить Заказчику оригинал
    Акта приемки-передачи оказанных услуг по почтовому адресу, указанному Заказчиком в Брифе.
...
* 4.3. Заказчик обязан:
  ...
  - 4.3.5. Заказчик гарантирует наличие необходимых соглашений с правообладателями
    ...
    С момента приемки-передачи выполненных работ по настоящему договору, Заказчик обязуется
    удостовериться в том, что все тексты, шрифты, изображения и файлы, размещенные на
    Web-сайте размещены на законных основаниях и Заказчик имеет на руках подтверждение законности
    их размещения, в том числе но не исключительно: авторские договоры, договоры с моделью,
    договоры купли-продажи изображений, лицензии фотостоков и любые иные документы, подтверждающие
    правомерность использования текстов, шрифтов, изображений и любых файлов на Web-сайте. Также
    Заказчик несет ответственность за контроль соблюдения сроков использования текстов, шрифтов,
...
4.1.1 настоящего договора. Исполнитель освобожден от уплаты НДС на основании
подпункта 26 статьи 149 Налогового кодекса Российской Федерации. 
...
* 5.3. Стоимость услуг за техническую поддержку Сайта по настоящему договору
  ...
  российских рублях. Предоставление дополнительных ресурсов оплачивается
...
* 6.2. Исполнитель направляет Заказчику оригинал Акта по почтовому адресу, указанному
  Заказчиком в Заявке, не позднее 10-ти рабочих дней с момента направления Заказчику
...
* 7.7. Исполнитель не несет ответственности перед Заказчиком, а также любыми
  третьими лицами за содержание материалов (текстов, шрифтов, изображений
  и/или файлов), представленных Заказчиком или размещаемых на Web-сайте Исполнителем
