...
* 1.1. Бриф – документ, в котором Сторонами определяются все 
  существенные параметры будущей рекламной кампании. Бриф содержит в себе: 
  цели запуска рекламной кампании, наименование товара (услуги), 
  ...
  Исполнителя и при его утверждении направляется Заказчиком на электронную
  почту Исполнителя или путем направления сообщения в мессенджерах. 
  
* 1.2. Бюджет рекламной кампании - сумма, фактически перечисленная 
  Заказчиком Исполнителю и предназначенная для зачисления в систему 
  Яндекс.Директ в полном объеме.

* 1.3. Геотаргетинг - показ Рекламного объявления пользователям, 
  имеющим адреса компьютеров (или прокси-серверов) в сети Интернет, 
  по сведениям системы «Яндекс.Директ» относящихся к заданному
  географическому региону.

* 1.4. Группа рекламных кампаний - совокупность заказанных Рекламодателем 
  Рекламных объявлений в рамках одной или нескольких рекламных кампаний 
  в системе «Яндекс.Директ», направленных на продвижение одного продукта
  (товара или услуги) или группы схожих продуктов.

* 1.5. ЕРИР - единый реестр интернет-рекламы

* 1.6. Заявка - указание Заказчика Исполнителю об изменении действующей 
...
* 1.7. Клик - обращение пользователя по содержащейся в Рекламном 
  объявлении Ссылке после показа такому пользователю этого 
  Рекламного объявления.

* 1.8. Ключевой запрос - слово или словосочетание, используемое в 
  рекламной кампании в системе «Яндекс.Директ», при запросе которого в поисковой
  системе может быть показано рекламное объявление.
  
* 1.9. Контекстная реклама - показ Рекламного объявления, который 
...
* 1.10. Личный кабинет - сведения, предоставляемые системой 
  Яндекс.Директ о рекламных кампаниях Заказчика. Исполнитель предоставляет
  Заказчику в рамках настоящей Публичной оферты доступ к личному кабинету
  в системе Яндекс.Директ с правом просмотра информации.

* 1.11. ОРД - оператор рекламных данных

* 1.12. Отчет - сведения, предоставляемые еженедельно Исполнителем 
...
* 1.14. Поисковая реклама - показ Рекламного объявления, который 
...
* 1.15. Поисковая система - программно-аппаратный комплекс Яндекс,
  интерфейс которого размещен в сети Интернет, предназначенный 
  для поиска пользователями информации в сети Интернет.

* 1.16. Поисковый запрос - текстовой запрос на поиск информации в сети 
  Интернет, введенный пользователем в строке поиска интерфейса 
  поисковой системы.

* 1.17. Показ - размещение/отображение Рекламного объявления в специально 
  ...
  Интернет, тематика которых, по мнению системы «Яндекс.Директ»,
  отвечает тематике ключевого слова/словосочетания, 
...
* 1.18. Пользователь - посетитель информационных ресурсов в сети Интернет.

* 1.19. Расчетная стоимость рекламной кампании - стоимость, 
  рассчитанная исходя из предполагаемой сторонами цены и количества 
  кликов за следующий(е) отчетный(е) период(ы).

* 1.20. Рекламное объявление - рекламный текст или баннер, содержащий 
  рекламную информацию и Ссылку, предоставленные Рекламодателем 
  в рамках определенной Рекламной кампании.

* 1.21. Рекламодатель - лицо, заинтересованное в привлечении посетителей 
  на свой сайт путем размещения рекламы в системе Яндекс.Директ. В рамках
  данной Публичной оферты в качестве рекламодателя выступает Исполнитель
  от имени Заказчика.

* 1.22. Ссылка - включенная в Рекламное объявление текстовая ссылка, 
  переадресующая обратившихся к ней посредством Клика пользователей
  к информационному ресурсу (сайту) в сети Интернет, адрес 
  (URL) которого указан Рекламодателем для данного Рекламного объявления 
  далее - «Ссылка на сайт»).
  
* 1.23. Страница результатов поиска - страница сайта в сети Интернет, 
  содержащая ссылки на ресурсы сети Интернет (сайты, веб-страницы), 
  отобранные поисковой системой по поисковому запросу.

* 1.24. Стыковочный месяц - месяц, необходимый для перехода на отчётный
  период - календарный месяц.

* 1.25. Фактическая стоимость рекламной кампании - стоимость, 
  рассчитанная исходя из фактической цены и количества кликов 
  за предыдущий отчетный период.

* 1.26. ФЗ№347 - Федеральный Закон от 02.07.2021 347-ФЗ 
  "О внесении изменений в федеральный закон "О рекламе"
  
* 1.27 Электронная почта - адреса электронной почты Заказчика и Исполнителя,
  которые они указали в разделе 13 настоящего публичного договора-оферты и
  переписку по которым стороны признают юридически значимой друг для друга и
  для третьих лиц.

* 1.28. Сообщения в мессенджерах - сообщения, направляемые Исполнителем и Заказчиком
  друг другу в мессенджерах по номерам телефонов, указанных в разделе 13
  настоящего публичного договора-оферты. Такие сообщения стороны признают юридически
  значимыми друг для друга и для третьих лиц. Сообщения в мессенджерах могут содержать
  текстовую часть, голосовые сообщения, изображения и файлы.
  Стороны пришли к согласию, что они не будут удалять или модифицировать направленные
  друг другу сообщения, даже при наличии такой технической возможности, не будут в чатах
  устанавливать режим автоматического удаления сообщений, так как признают за такими
  сообщениями статус волеизъявления сторон.
...
* 2.1. Исполнитель обязуется на основании брифа и заявок Заказчика 
  ...
  услуг Заказчика в системе Яндекс.Директ, а 
  Заказчик обязуется принять и оплатить оказанные услуги. Услуги 
  включают в себя:

  - 2.1.1. Подбор списка ключевых запросов;

  - 2.1.2. Подготовка и размещение Рекламных объявлений в системе Яндекс.Директ;

  - 2.1.3. Управление рекламными кампаниями в системе Яндекс.Директ;
    
  - 2.1.4. Предоставление доступа на просмотр в личный кабинет в системе Яндекс.Директ,
    еженедельных и ежемесячных отчетов о ходе рекламной кампании Яндекс.Директ,
    в порядке, предусмотренном п. 4.10 настоящего Договора.

* 2.2.  Цели рекламной кампании, регионы показа объявлений, продвигаемые услуги/направления
  и иные параметры размещения обсуждаются Сторонами на этапе согласования брифа.
  При этом Заказчик имеет право внести правки в запущенную
  рекламную кампанию, но не более 3-х раз. Стоимость дополнительно
  выполняемых работ определяется исходя из объема работ (в часах)
  и стоимости 1 часа работы специалиста в соответствии с расценками,
  опубликованными по адресу: https://www.synapse-studio.ru/catalog/kontekstnaya-reklama.

  - 2.2.1. Внесение технических корректировок в запущенную рекламную кампанию,
    не меняющих существенных условий согласованного Брифа (например, корректировка
    минус-слов, замена текстов объявлений в рамках той же стратегии), осуществляется
    Исполнителем в рамках ежемесячного обслуживания без дополнительной оплаты;
  - 2.2.2. Заказчик вправе заказать дополнительные услуги, связанные с запущенными
    рекламными кампаниями, которые не входят в выбранный им тариф. После согласования
    с Заказчиком перечня и стоимости дополнительных услуг, Исполнитель направляет
    Заказчику счет на оплату дополнительных услуг на условиях предварительной оплаты.
    Оплата счета означает безусловное согласие Заказчика с перечнем дополнительно
    оказываемых услуг, их стоимостью, а также сроком их оказания, указанными в счете на оплату.
...
* 2.4. До начала работы над Договором Стороны обмениваются основными 
  ...
  почте или путем направления сообщения в мессенджерах.
...
* 4.2. В срок не позднее 3-х рабочих дней с момента поступления денежных 
  ...
  утверждения основных условий рекламной кампании.
...
* 4.4. Исполнитель в срок не позднее 3-х рабочих дней с момента 
  ...
  зачисления вышеуказанных денежных средств на счет Яндекс.Директ и
  утверждения Брифа настраивает рекламную кампанию и 
  производит ее запуск. При этом моментом запуска рекламной кампании 
  считается дата направления Исполнителем рекламной кампании на модерацию.

* 4.5. При этом одна группа рекламных кампаний в системе Яндекс.Директ:
  - 4.5.1. Направлена на продвижение одного продукта (товара или 
    услуги) или группы схожих продуктов;
  - 4.5.2. Ссылается на Интернет-ресурс Заказчика в пределах одного 
    доменного имени;
  - 4.5.3. Имеет до двухсот объявлений в системе Яндекс.Директ 
    и (или) до трехсот ключевых запросов;
  - 4.5.4. Может содержать до 4 кампаний в системе Яндекс.Директ;
  - 4.5.5. Имеет 1 клиентский логин и пароль для просмотра кампаний 
    в личном кабинете Яндекс.Директ;
  - 4.5.6. Находится под управлением Исполнителя.

* 4.6. Заказчик вправе в любое время изменять параметры рекламной 
  кампании путем направления в адрес Исполнителя заявок с соответствующими
  указаниями. Заявки направляются по электронной почте Заказчика или путем
  направления сообщения в мессенджерах. Заявки принимаются исполнителем по 
  рабочим дням с 09:00 до 17:00. Срок обработки заявки 
  Исполнителем - три часа. 
  
* 4.7. В рамках заявки могут быть изменены следующие параметры рекламной 
  кампании:

  - 4.7.1. Включение или выключение кампании;

  - 4.7.2. Добавление рекламных кампаний при условии предварительной 
  оплаты в соответствии с п. 6 настоящего Договора, при условии 
  соответствия новой рекламной кампании правилу, предусмотренному п. 4.5 
  настоящего Договора;

  - 4.7.3. Изменение текста объявлений, при 
  условии соответствия текста правилу, предусмотренному 
  п. 4.5 настоящей Публичной оферты;

  - 4.7.4. Добавление и исключение ключевых фраз при условии соответствия
    фраз правилу, предусмотренному п. 4.5 настоящего Договора;

  - 4.7.5. Увеличение или уменьшение бюджета рекламной кампании;

  - 4.7.6. Изменение ссылки на сайт в пределах одного доменного имени;

  - 4.7.7. Изменение регионов показа рекламных объявлений.

* 4.8. Исполнитель при получении заявки направляет заказчику 
  по электронной почте уведомление о получении заявки, 
  а также о сроках ее исполнения. Уведомление направляется по электронной
  почте Исполнителя или путем направления сообщения в мессенджерах. 


* 4.9. Исполнитель предоставляет Заказчику доступ в личный
  кабинет в системах Яндекс.Директ на представителя
  с типом доступа "Чтение". Заказчик предоставляет адрес электронной
  почты представителя, который ранее не использовался для работы в Директе.
  
* 4.10. Исполнитель не несёт ответственности в
  случае использования логина и пароля аккаунта Заказчика третьими
  лицами. Заказчик обязуется принять необходимые меры для сохранности
  своего логина и пароля.

* 4.11. Еженедельно по понедельникам Исполнитель направляет Заказчику 
...
* 4.12. Передача Исполнителем Рекламной кампании Заказчику по его
  письменной заявке возможна после запуска Рекламной кампании. Перенос
  осуществляется через функцию передачи аккаунта в кабинете Директа -
  https://yandex.ru/support/direct/ru/agencies/account-transfer.
  Перенос аккаунтов в других сервисах Яндекса (Яндекс Бизнес, ПромоСтраницы и др.)
  не предусмотрен. Услуга считается оказанной в полном объёме,
...
* 5.1. Исполнитель обязан:
  ...
  - 5.1.3. При наличии заявки Заказчика, направлять ему отчет о рекламной
    кампании за предыдущий месяц. Отчет направляется не чаще, чем один раз
    в месяц на электронную почту Заказчика или в мессенджер в виде ссылки
    на биз-панель или в формате PDF;
...
* 5.2. Заказчик обязан:
  ...
  индивидуализации.
  Исполнитель освобождается от проверки соблюдения Заказчиком действующего
...
* 5.3. Исполнитель имеет право:
  ...
  - 5.3.5. Размещать в рекламных целях информацию о настоящем договоре
    на любых интернет и офлайн-ресурсах, содержащую в том числе, но не исключительно:
    наименование Заказчика, бюджет, потраченный на рекламу, результаты рекламной кампании
    (заявки, клики, показы рекламы), рекламные материалы (баннеры, объявления), процесс
    коммуникации с Заказчиком. Указанную информацию Исполнитель вправе размещать без
    дополнительного согласования с Заказчиком;

  - 5.3.6. Заказчик гарантирует наличие необходимых соглашений с правообладателями при
    необходимости таковых в соответствии с действующим законодательством, в том числе
    в отношении всех размещаемых на Web-сайте текстов, шрифтов, изображений и файлов,
    даже если эти файлы размещены Исполнителем по поручению Заказчика.

    Заказчик с даты подписания им акта приемки-передачи выполненных работ по настоящему
    договору принимает на себя риски предъявления претензий любыми третьими лицами в отношении
    любых текстов, шрифтов, изображений и файлов, размещенных на Web-сайте и в рекламных
    объявлениях. С момента приемки-передачи выполненных работ по настоящему договору, Заказчик
    обязуется удостовериться в том, что все тексты, шрифты, изображения и файлы, размещенные на
    Web-сайте и в рекламных объявлениях, размещены на законных основаниях и Заказчик имеет на руках
    подтверждение законности их размещения, в том числе но не исключительно: авторские договоры,
    договоры с моделью, договоры купли-продажи изображений, лицензии фотостоков и любые иные документы,
    подтверждающие правомерность использования текстов, шрифтов, изображений и любых файлов на Web-сайте и
    в рекламных объявлениях. Также Заказчик несет ответственность за контроль соблюдения сроков
    использования текстов, шрифтов, изображений и любых файлов на Web-сайте и в рекламных объявлениях,
    если такие сроки установлены подтверждающими документами. 
...
* 5.4. Заказчик имеет право:
  ...
  - 5.4.2. Требовать от Исполнителя выполнения работ, указанных в заявке и описанных в Брифе.

## 6. Стоимость услуг и порядок расчетов

* 6.1. Стоимость услуг по настройке и сопровождению одной группы рекламных кампаний
  Заказчика определяется Исполнителем в рамках одного из тарифов, которые опубликованы
  по адресу: https://www.synapse-studio.ru/product/yandeksdirekt-tarif-bazovyy-abonentskaya.
  Выбор тарифа осуществляется Заказчиком путем указания на него в брифе и в дальнейшем
  корректируется путем направления уведомлений в адрес Исполнителя по электронной почте или
  путем направления сообщения в мессенджерах.
  При этом Исполнитель направляет Заказчику счет на оплату с указанием стоимости услуг.

  
* 6.2. Стоимость услуг за календарный месяц является фиксированной и не зависит
  от фактического количества дней в течение которых была включена рекламная кампания.
  В случае, если рекламная кампания в первом месяце обслуживания была активна 

