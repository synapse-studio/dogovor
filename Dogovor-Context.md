...
* 1.22. Ссылка – включенная в Рекламное объявление текстовая ссылка, 
  ...
  - 1.22.1. к информационному ресурсу (сайту) в сети Интернет, адрес 
  (URL) которого указан Рекламодателем для данного Рекламного объявления 
  далее - «Ссылка на сайт»); или;
  
  - 1.22.2. на специальную Интернет-страницу, содержащую предоставленную 
...
* 1.26. ФЗ№347 - Федеральный Закон от 02.07.2021 347-ФЗ 
  ...
  друг другу в мессенджерах WhatsApp, Telegram и других (за исключением мессенджеров,
  заблокированных на территории РФ) по номерам телефонов, указанных в разделе 13
...
* 2.1. Исполнитель обязуется на основании брифа и заявок Заказчика 
  ...
  системе Яндекс.Директ и еженедельных отчетов 
  о ходе рекламной кампании Яндекс.Директ, 
...
* 2.2. Список ключевых запросов, максимальная стоимость клика,
  ...
  размещения обсуждаются Сторонами на этапе согласования брифа.
...
* 4.5. При этом одна группа рекламных кампаний в системе Яндекс.Директ:
  ...
  - 4.5.6. Находяится под управлением Исполнителя.
...
* 4.7. В рамках заявки могут быть изменены следующие параметры рекламной 
  ...
  - 4.7.1. Включение или выключение кампании (не более 2-х раз в неделю);
  ...
  - 4.7.3. Изменение текста объявлений (не более 2-х раз в месяц), при 
  условии соответствия текста правилу, предусмотренному 
  п. 4.5 настоящей Публичной оферты;

  - 4.7.4. Добавление и исключение ключевых фраз (не более 2х раз 
...
* 4.12. Передача Исполнителем Заказчику Рекламной кампании по письменной
  заявке последнего возможна после запуска Рекламной кампании. При этом
  Заказчик осуществляет перенос Рекламной кампании самостоятельно, в случае
  использования Яндекс.Директ – через личный кабинет Яндекса при помощи
  excel - https://yandex.ru/support/direct/alternative-interfaces/xls-interface.html,
  Услуга считается оказанной в полном объёме, оплата стоимости не возвращается.
...
* 6.5. Расчетная стоимость рекламной кампании определяется Исполнителем 
  ...
  AdWords, но не менее 20000 (Двадцати тысяч) рублей в месяц.
