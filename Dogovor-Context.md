...
* 1.25. Фактическая стоимость рекламной компании – стоимость, 
...
* 5.3. Исполнитель имеет право:
  ...
  - 5.3.6. Заказчик гарантирует наличие необходимых соглашений с правообладателями
    при необходимости таковых в соответствии с действующим законодательством,
    в том числе в отношении всех размещаемых на Web-сайте текстов, шрифтов, изображений
    и файлов, даже если эти файлы размещены Исполнителем по поручению Заказчика.
    ...
    любых текстов, шрифтов, изображений и файлов, размещенных на Web-сайте. С момента
    приемки-передачи выполненных работ по настоящему договору, Заказчик обязуется
    удостовериться в том, что все тексты, шрифты, изображения и файлы, размещенные
    на Web-сайте размещены на законных основаниях и Заказчик имеет на руках подтверждение
    законности их размещения, в том числе но не исключительно: авторские договоры,
    договоры с моделью, договоры купли-продажи изображений, лицензии фотостоков и любые
    иные документы, подтверждающие правомерность использования текстов, шрифтов,
    изображений и любых файлов на Web-сайте. Также Заказчик несет ответственность
    за контроль соблюдения сроков использования текстов, шрифтов, изображений и любых
    файлов на Web-сайте, если такие сроки установлены подтверждающими документами.
 ...
 * 8.6. В соответствии с Федеральным законом № 229-ФЗ от 27.07.2010 года и
  Федеральным законом № 63-ФЗ от 06.04.2011 года Стороны настоящего Договора с
  оглашаются осуществлять документооборот в электронном виде через СБИС с использованием
