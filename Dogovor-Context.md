...
* 1.5. (доб) Рекламодатель — лицо, заинтересованное в привлечении посетителей 
  на свой сайт путем размещения рекламы в интернете. (либо расписать - в системе Яндекс.Директ 
  и/или Google AdWords, ВКонтакте, Instagram, MyTarget 
  и Facebook либо "путем размещения контекстной и таргетированной рекламы в интернете"). В рамках данной Публичной оферты в качестве 
...
* 1.7. (доб) Ключевой запрос – слово или словосочетание, используемое в 
  рекламной кампании (в системе «Яндекс.Директ» и/или Google AdWords -убрать) 
  при запросе которого (в поисковой системе - убрать) может быть показано 
...
* 1.8. Ссылка – включенная в Рекламное объявление текстовая ссылка, 
  ...
  (далее - «Ссылка на контактную страницу») или;
  
  - 1.8.3. (доб) к странице в социальных сетях.
  
* 1.9. (доб) Группа рекламных кампаний – совокупность заказанных Рекламодателем 
  Рекламных объявлений в рамках одной или нескольких рекламных кампаний, 
  (в системе «Яндекс.Директ» и/или Google AdWords - убрать?) направленных на 
  продвижение одного продукта (товара или услуги) или группы схожих 
  продуктов (и ведущих на один сайт/группу в 
...
* 1.23. Площадка социальных сетей – онлайн-платформа, предназначенная для 
  общения, поиска друзей и информации, размещения рекламных проектов.
  
* 1.24. Таргетированная реклама - это форма онлайн-рекламы, показывающая 
