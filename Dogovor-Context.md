...
* 1.8  Ссылка – включенная в Рекламное объявление текстовая ссылка, 
  ...
  - к информационному ресурсу (сайту) в сети Интернет, адрес (URL) 
    которого указан Рекламодателем для данного Рекламного объявления 
	(далее - «Ссылка на сайт»); или;
  - на специальную Интернет-страницу, содержащую предоставленную 
...
* 4.2 Одна группа рекламных кампаний в системе Яндекс.Директ и/или Google AdWords:
  - направлена на продвижение одного продукта (товара или 
    услуги) или группы схожих продуктов;
  - ссылается на Интернет-ресурс Заказчика в пределах одного 
    доменного имени;
  - имеет до двухсот объявлений в системе Яндекс.Директ 
    и/или Google AdWords и (или) до трехсот ключевых запросов;
  - может содержать до 5 кампаний в системе Яндекс.Директ 
    и/или Google AdWords;
  - имеет 1 клиентский логин и пароль для просмотра кампаний 
    в личном кабинете Яндекс.Директ и/или Google AdWords;
  - находятся под управлением Исполнителя.
...
* 5.3 Исполнитель имеет право:
  ...
  - изменять заголовки объявлений
  - изменять тексты объявлений
  - отключать отдельные объявления
  - изменять ставки по кликам в пределах, согласованных с Заказчиком
...
* 6.3 Расчетная стоимость рекламной кампании определяется Исполнителем 
  ...
  - Исполнитель по указанию Заказчика направляет счет на оплату денежных 
  ...
  - Денежные средства, перечисленные Заказчиком на расчетный счет Исполнителя 
  ...
  - В случае, если Заказчиком не оплачен счет Исполнителя на оказание услуг, 
