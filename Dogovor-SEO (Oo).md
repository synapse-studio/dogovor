...
* ООО «о.О», именуемое в дальнейшем «Исполнитель», заключит договор на 
  оказание услуг по SEO-продвижению сайта (далее – «Договор») 
...
* В целях единообразия использования терминов и определений при исполнении настоящего 
  ...
  - Технические тексты, изображения и файлы - это тексты, изображения и файлы, права на которые
    принадлежат Исполнителю и размещаются на Web-сайте временно в связи с непредставлением
    Заказчиком своих текстов, изображений и/или файлов. При этом Заказчик не вправе предъявлять
    Исполнителю никаких претензий в связи с размещением указанных файлов, в том числе в связи
    с их неуникальностью и размещении на других сайтах.
...
* 2.2. Предметом настоящего договора является запуск кампании по SEO-продвижению и ежемесячное 
  ...
  - 2.2.1. Запуск кампании представляет из себя анализ сайта заказчика и поисковых запросов и
    результатом такого анализа является разработка стратегии, которая по окончании этого этапа направляется
    Заказчику в формате на электронную почту Заказчика или в мессенджер в виде ссылки или в формате PDF.
...
* 2.4. Заказчик гарантирует наличие необходимых лицензий, сертификатов, государственных регистраций и
  ...
  на себя риски предъявления претензий любыми третьими лицами в отношении любых текстов, изображений и файлов,
  размещенных на Web-сайте. С момента приемки-передачи выполненных работ по настоящему договору, Заказчик
  обязуется удостовериться в том, что все тексты, изображения и файлы, размещенные на Web-сайте размещены
  на законных основаниях и Заказчик имеет на руках подтверждение законности их размещения, в том числе но
  не исключительно: авторские договоры, договоры с моделью, договоры купли-продажи изображений, лицензии
  фотостоков и любые иные документы, подтверждающие правомерность использования текстов, изображений и любых
  файлов на Web-сайте. Также Заказчик несет ответственность за контроль соблюдения сроков использования текстов,
  изображений и любых файлов на Web-сайте, если такие сроки установлены подтверждающими документами.
...
* 5.1. Исполнитель обязан:
  ...
  - 5.1.2. Ежемесячно в срок не позднее 10 числа месяца направлять в адрес Заказчика Акт сдачи-приемки услуг, оказанных
    в предыдущем месяце.
...
* 5.3. Заказчик обязан:
  ...
  - 5.3.4. Заказчик гарантирует наличие необходимых соглашений с правообладателями при необходимости таковых
    ...
    авторские договоры, договоры с моделью, договоры купли-продажи изображений, лицензии фотостоков и любые иные документы,
    подтверждающие правомерность использования текстов, шрифтов, изображений и любых файлов на Web-сайте. Также Заказчик
    несет ответственность за контроль соблюдения сроков использования текстов, шрифтов, изображений и любых файлов на
    Web-сайте, если такие сроки установлены подтверждающими документами.
...
* 7.2. В срок не позднее 10-го числа месяца, следующего за отчетным, Исполнитель высылает скан акта приемки-передачи
  ...
  оригинала акта приемки-передачи оказанных услуг в адрес Заказчика с обязательным указанием адреса, на который будет направлен оригинал.
