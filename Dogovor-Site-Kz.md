...
* Товарищество с ограниченной ответственностью "Синапсис", 
...
* 3.1. Текст настоящего Договора является публичной офертой в соответствии 
  со статьей 395 Гражданского Кодекса Республики Казахстан.
...
* 4.2. Исполнитель вправе:
 ...
 несет ответственность за действия указанных лиц как за свои собственные.
  ...
  фактические действия, связанные с регистрацией доменного имени в зоне .ru, .kz, рф.
...
* 5.3. Стоимость услуг за техническую поддержку Сайта по настоящему договору 
  ...
  устанавливается в казахстанский тенге. Предоставление дополнительных ресурсов 
...
* 5.6. Форма оплаты: внесение наличных денежных средств в кассу Исполнителя
  ...
  переводом или иным допустимым законодательством способом из числа принимаемых 
  Исполнителем.
...
```
Наименование: ТОО "СИНАПСИС"
Адрес: Казахстан, Западно-Казахстанская область, город
Уральск, улица Дины Нурпеисовой, здание 12, почтовый
индекс 090000
БИН: 220540009096
Номер счета: KZ0396515F0008122602 KZT
КБе: 17
БИК: IRTYKZKA
Наименование Банка: Филиал АО "ForteBank" в г. Актобе
...
| Объем сайта | Оплата раз в месяц, тенге/год | Раз в пол года, тенге/год |    За год, тенге/год |
|:------------|----------------------------:|------------------------:|-------------------:|
| до 1 гб     |                       41000 |                   24500 |              16500 |
| до 3 гб     |                           - |                       - |              65500 |
| до 5 гб     |                           - |                       - |              82000 |
| от 5 гб     |                           - |                       - | 82000 + доп.место* |

#### Сайт каталог (товары, услуги, проекты)

| Объем сайта| Оплата раз в месяц, тенге/год | Раз в пол года, тенге/год |    За год, тенге/год |
|:---------- |----------------------------:|------------------------:|-------------------:|
| до 1 гб    |                       49000 |                   41000 |              33000 |
| до 3 гб    |                           - |                       - |              65000 |
| до 5 гб    |                           - |                       - |              82000 |
| от 5 гб    |                           - |                       - | 82000 + доп.место* |
...
|:-------------------------------------|-------------------------------------:|------------------:|------------------:|----------------------:|
|Стоимость месяца при оплате за год|   5200 ₸/месяц | 10200  ₸/месяц  | 20400 ₸/месяц | 30600 ₸/месяц |
|Стоимость при оплате за месяц|   6800 ₸/месяц | 13600 ₸/месяц | 27300 ₸/месяц| 41000 ₸/месяц|
...
сервера и наших работ по сопровождению серверов (установка - 68 000 ₸., ежемесячное 
обслуживание сервера - 34 000 ₸.)
...
- Создание необходимого количества копий сайта (для выполнения доработок, 
  ...
  обслуживание сервера -  34 000 ₸/мес);
- Продление одного доменного имени в зонах .ru, .рф, .kz при условии что домен 
...
- консультации по работе с сайтом, изменение контента сайта: стоимость определяется 
  исходя из объема работ (в часах) и стоимости 1 часа работы менеджера 10300 ₸/час 
  для типовых решений;
- исправление ошибок, связанных с изменениями в архитектуре сайта и алгоритмах ввода 
  ...
  и стоимости 1 часа работы программиста 17000 ₸/час для типовых решений;
- доработки на сайте, не связанные с интеграцией с учетной системой и другими сервисами: стоимость 
  определяется исходя из объема работ (в часах) и стоимости 1 часа работы программиста 
  17000 ₸/час для типовых решений;
- доработка алгоритмов выгрузки, связанных с изменениями параметров выгрузки на стороне учетной системы: 
  стоимость определяется исходя из объема работ (в часах) и стоимости 1 часа работы 
  программиста - 20500 ₸/час;
- выделенный сервер: стоимость определяется из стоимости аренды сервера и наших работ 
  по сопровождению серверов (установка при старте - 68 000 ₸, ежемесячное обслуживание 
  сервера -  34 000 ₸.)
- покупка и поддержка дополнительного домена: 4000 ₸/год;
