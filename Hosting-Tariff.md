...
## Тарифы на техническую поддержку сайтов с 2021 года:
...
| Тип оплаты| Магазин до 2000 товаров, без интеграций (до 5гб)| Магазин до 5000 товаров, простой обмен с учетной системой| Магазин до 5000 товаров, нестандартный обмен с учетной системой | Магазин от 5000 - 20000 товаров с интеграциями, бонусной системой|
|:-------------------------------------|-------------------------------------:|------------------:|------------------:|----------------------:|
...
Стоимость дополнительного места для магазинов до 2000 товаров, без интеграций  тарифицируются как 2400 р. за каждый превышающий гб:

|Объем             | 1 гб |  5 гб |  10 гб |  20 гб | 30 гб |
|:-----------------|-----:| -----:|------:|------:|------:|
...
- Консультации по работе с сайтом продолжительностью не более 30 минут. Количество обращений в месяц определяется видом типового сайта:
  ...
  - Сайт каталог (товары, услуги, проекты) - 2 обращения
  - Интернет-магазин до 2000 товаров, без интеграций - 1 обращение
  - Интенет-магазин до 5000 товаров, простой обмен с учетной системой - 1 обращение
...
- консультации по работе с сайтом, изменение контента сайта: стоимость определяется 
  исходя из объема работ (в часах) и стоимости 1 часа работы менеджера 2500 руб/час 
  для типовых решений;
