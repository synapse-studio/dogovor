...
* ООО «о.О», именуемое в дальнейшем «Исполнитель», заключит договор на 
  оказание услуг по созданию сайта (далее – «Договор») 
...
* Бриф заполняется Заказчиком по форме Исполнителя и при его утверждении
  направляется Заказчиком на электронную почту Исполнителя или путем
  направления сообщения в мессенджерах.

* Наполнение страницы сайта - размещение на ней до 1000 знаков текста и
  до 30 фотографий в формате .jpg без какого-либо форматирования. Все информационные
  материалы, предназначенные для размещения на сайте, предоставляются Заказчиком в
  электронном виде, в одном из следующих форматов: для текстов – форматы .doc, .docx,
  .odt; для фотографий: .jpg, .png.

* Технические тексты, шрифты, изображения и файлы - это тексты, шрифты,
  изображения и файлы, права на которые принадлежат Исполнителю и размещаются
  на Web-сайте временно в связи с непредставлением Заказчиком своих текстов,
  изображений и/или файлов. При этом Заказчик не вправе предъявлять Исполнителю
  никаких претензий в связи с размещением указанных файлов, в том числе в связи
...
услуг, а также сроком их оказания, указанным в пункте 4.1.1 настоящего договора.
  ...
  - 2.2.6. Исполнитель на основании информации, полученной от Заказчика, заполняет
    Бриф, в котором указывает представление Заказчика о Web-сайте, его название,
    цели, формы и содержание (графическое и программное). Заполненный Бриф Исполнитель
    направляет Заказчику на согласование, Заказчик согласовывает и направляет Исполнителю
    согласованный Бриф, а также информацию, файлы и изображения, которые необходимо
    разместить на Web-сайте. Заказчик вправе направить информацию, файлы и изображения
    после направления Брифа, однако Исполнитель в таком случае вправе увеличить срок
    исполнения работ по настоящему договору на период просрочки Заказчиком предоставления
    информации, файлов и изображений.
  
  - 2.2.7. Исполнитель публикует тестовую версию сайта и осуществляет наполнение сайта
    на основании информации, предоставленной Заказчиком в Брифе и направленной одновременно
    с Брифом (или позднее см. п. 2.2.6).

    При этом по согласованию с Заказчиком Исполнитель использует на Web-сайте:

    - тексты, изображения, шрифты и файлы, которые направил Заказчик,
    - тексты, изображения, шрифты и файлы, которые по поручению Заказчика Исполнитель приобрел
    за плату или без у третьих лиц, в том числе на фотостоках,
    - технические тексты, шрифты, изображения и файлы.

    Услуги по подбору и приобретению текстов, шрифтов, файлов и изображений оплачиваются в соответствии
    с прейскурантом Исполнителя, действующим на момент приобретения таких изображений. При этом Заказчик
    обязуется оплатить стоимость самих текстов, шрифтов, изображений и/или файлов, так и оплатить услугу
    по их подбору.
  ...
  - 2.2.10. После письменного утверждения на электронную почту Исполнителя или путем направления сообщения
    в мессенджерах Заказчиком тестовой версии сайта, Исполнитель подключает к сайту выбранный или
    предоставленный Заказчиком домен (1-3 рабочих дня при условии заполнения Заказчиком анкеты и/или
    предоставления необходимых документов) и размещает сайт в сети Интернет.
  ...
  - 2.2.12. Исполнитель регистрирует сайт Заказчика в поисковой системе Яндекс. Регистрация подразумевает
    отправку запроса на индексацию сайта указанными поисковыми системами, при этом сам процесс индексации
    находится вне ведения Исполнителя и зависит от текстового наполнения сайта и иных требований фильтров
    поисковых систем. Исполнитель устанавливает счетчики Яндекс.Метрики без настройки целей.
...
* 2.3 Услуги по технической поддержке сайта по настоящему Договору включают 
  ...
  - 2.3.1. размещение сайта на хостинге Исполнителя. Технические характеристики
    хостинга Исполнителя указаны на сайте https://www.synapse-studio.ru/doc/site-syn;
...
* 4.1. Исполнитель обязан:
  ...
  технической поддержке и доработке сайта. Стоимость и полный перечень предоставляемых
  услуг согласуются Сторонами в счете на предварительную оплату.
    
    Срок оказания услуг по созданию сайта составляет 30 календарных дней и начинает течь
  с момента поступления предварительной оплаты. 

  - 4.1.2. По завершению работ направить Заказчику акт приемки-передачи оказанных услуг
    в электронном виде по адресу электронной почты, указанной Заказчиком в Брифе. Не позднее
    10-ти рабочих дней с момента направления Заказчику Акта приемки-передачи оказанных услуг
    в электронном виде, направить Заказчику оригинал Акта приемки-передачи оказанных услуг
    по почтовому адресу, указанному Заказчиком в Брифе.
  
  - 4.1.3. По письменному требованию Заказчика предоставить ему экземпляр Договора 
  с подписью и печатью Исполнителя.
  
  - 4.1.4. В течение срока действия договора оказывать консультации по вопросам работы
    с сайтом в соответствии с Положением об оказании услуг технической поддержки согласно
    информации указанной на сайте https://www.synapse-studio.ru/doc/site-syn. 
...
* 4.3. Заказчик обязан:
  ...
  - 4.3.3. Своевременно производить оплату услуг в соответствии с условиями настоящего
    Договора, в том числе оплатить стоимость как самих текстов, шрифтов, изображений и/или
    файлов, так и оплатить услугу по их подбору.

  - 4.3.4. Подписать акт и принять оказанные услуги в соответствии с правилами, 
  указанными в п. 6.3 настоящего договора.
  
  - 4.3.5. Заказчик гарантирует наличие необходимых соглашений с правообладателями при
    ...
    приемки-передачи выполненных работ по настоящему договору, Заказчик обязуется удостовериться
    в том, что все тексты, шрифты, изображения и файлы, размещенные на Web-сайте размещены на
    законных основаниях и Заказчик имеет на руках подтверждение законности их размещения, в том
    числе но не исключительно: авторские договоры, договоры с моделью, договоры купли-продажи
    изображений, лицензии фотостоков и любые иные документы, подтверждающие правомерность
    использования текстов, шрифтов, изображений и любых файлов на Web-сайте. Также Заказчик
    несет ответственность за контроль соблюдения сроков использования текстов, шрифтов, изображений
    и любых файлов на Web-сайте, если такие сроки установлены подтверждающими документами.
...
* 5.1. Стоимость услуг по настоящему договору устанавливается Исполнителем в счете
на предварительную оплату. При этом оплата Заказчиком счета является подтверждением
безусловного согласия Заказчика с условиями настоящей оферты, перечнем и стоимостью услуг,
а также сроком их оказания, указанным в пункте 4.1.1 настоящего договора.
...
* 5.3. Стоимость услуг за техническую поддержку Сайта по настоящему договору установлена
  «Тарифами на услуги» (далее «Тарифы», согласно информации указанной на сайте https://www.synapse-studio.ru/doc/site-syn)
  и устанавливается в российских рублях. Предоставление дополнительных ресурсов оплачивается
  дополнительно в соответствии с «Тарифами на услуги».
  
* 5.4. Счета за услуги технической поддержки выставляются Исполнителем на период оплаты
  (отчетный период), согласно информации указанной на сайте https://www.synapse-studio.ru/doc/site-syn.
...
* 6.2. Исполнитель направляет Заказчику оригинал Акта по почтовому адресу,
  указанному Заказчиком в Заявке, не позднее 10-ти рабочих дней с момента
...
* 7.7. Исполнитель не несет ответственности перед Заказчиком, а также любыми
  третьими лицами за содержание материалов (текстов, шрифтов, изображений и/или
  файлов), представленных Заказчиком или размещаемых на Web-сайте Исполнителем
  по согласованию с Заказчиком, в том числе Исполнитель не несет ответственности
  за нарушение авторских и смежных прав третьих лиц.
...
* 7.22. Любая переписка с адреса электронной почты, заканчивающейся на @synapse-studio.ru,
  считается официальной и может быть использована в качестве доказательства направления
  документов контрагенту в суде.
