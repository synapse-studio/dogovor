...
* В целях единообразия использования терминов и определений при исполнении настоящего 
  ...
  - Технические тексты, изображения и файлы - это тексты, изображения и файлы, права на которые
    ...
    своих текстов, изображений и/или файлов. При этом Заказчик не вправе предъявлять Исполнителю никаких
    претензий в связи с размещением указанных файлов, в том числе в связи с их неуникальностью и
...
* 2.4. Заказчик гарантирует наличие необходимых лицензий, сертификатов, государственных регистраций и
  ...
  размещены на законных основаниях и Заказчик имеет на руках подтверждение законности их размещения,
  в том числе но не исключительно: авторские договоры, договоры с моделью, договоры купли-продажи изображений,
...
* 4.6. После окончания выполнения работ, указанных в п. 2.2.1 настоящего Договора Исполнитель направляет
  ...
  Исполнитель ежемесячно в срок не позднее 5 числа текущего месяца направляет Заказчику план работ на текущий месяц.
  Заказчик вправе представить свои предложения по изменению плана в срок не позднее 3-х календарных дней с момента
  его получения. Не направление Заказчиком в адрес Исполнителя предложений по плану продвижения до окончания текущего
  месяца означает согласие Заказчика с ним.
...
* 4.7. Исполнитель оказывает Заказчику дополнительные платные услуги по SEO-продвижению сайта Заказчика. Полный
  ...
  В случае, если Заказчик изъявляет желание получить какую-либо дополнительную услугу по SEO-продвижению сайта,
  то Исполнитель формирует счет на предварительную оплату выбранных Заказчиком услуг и передает его Заказчику. Стоимость и
...
* 5.1. Исполнитель обязан:
  ...
  - 5.1.2. Ежемесячно в срок не позднее 10 числа месяца направлять в адрес Заказчика Акт сдачи-приемки услуг, оказанных в предыдущем месяце.
  - 5.1.3. При наличии заявки Заказчика, направлять ему отчет о рекламной кампании за предыдущий месяц. Отчет направляется не чаще,
    чем один раз в месяц на электронную почту Заказчика или в мессенджер в виде ссылки или в формате PDF.
...
* 5.3. Заказчик обязан:
  - 5.3.1. Предоставлять Исполнителю информацию, необходимую для оказания услуг по настоящей Публичной оферте в форме заявок
    по электронной почте, которая привязана к доменному имени synapse-studio.ru или путем направления сообщения в мессенджерах. 
  ...
  - 5.3.4. Заказчик гарантирует наличие необходимых соглашений с правообладателями при необходимости таковых в соответствии
    с действующим законодательством, в том числе в отношении всех размещаемых на Web-сайте текстов, шрифтов, изображений и
    файлов, даже если эти файлы размещены Исполнителем по поручению Заказчика.

    Заказчик с даты подписания им акт приемки-передачи выполненных работ по настоящему договору принимает на себя риски
    предъявления претензий любыми третьими лицами в отношении любых текстов, шрифтов, изображений и файлов, размещенных
    на Web-сайте. С момента приемки-передачи выполненных работ по настоящему договору, Заказчик обязуется удостовериться в том,
    что все тексты, шрифты, изображения и файлы, размещенные на Web-сайте размещены на законных основаниях и Заказчик имеет
    на руках подтверждение законности их размещения, в том числе но не исключительно: авторские договоры, договоры с моделью,
    договоры купли-продажи изображений, лицензии фотостоков и любые иные документы, подтверждающие правомерность использования
    текстов, шрифтов, изображений и любых файлов на Web-сайте. Также Заказчик несет ответственность за контроль соблюдения сроков
    использования текстов, шрифтов, изображений и любых файлов на Web-сайте, если такие сроки установлены подтверждающими документами.
...
* 7.1. По окончанию выполнения работ, указанных в п. 4.1. и/или 4.7. настоящего Договора, Исполнитель направляет Заказчику
...
* 7.2. В срок не позднее 10-го числа месяца, следующего за отчетным, Исполнитель высылает скан акта приемки-передачи
  ...
  оригинала акта приемки-передачи оказанных услуг в адрес Заказчика с обязательным указанием адреса, на который будет направлен
  оригинал.
...
* 7.6. В соответствии с Федеральным законом № 229-ФЗ от 27.07.2010 года и Федеральным законом № 63-ФЗ от 06.04.2011 года
  Стороны настоящего Договора соглашаются осуществлять документооборот в электронном виде через СБИС с использованием электронной
  цифровой подписи и признавать юридическую силу всех электронных документов, в том числе счетов-фактур, УПД, если на момент
  формирования электронной цифровой подписи электронного документа сертификат ключа подписи руководителя организации, либо иного
