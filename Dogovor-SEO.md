...
* В целях единообразия использования терминов и определений при исполнении настоящего 
  ...
  - Бриф заполняется Заказчиком по форме Исполнителя и при его утверждении направляется
    Заказчиком на электронную почту Исполнителя или путем направления сообщения в мессенджерах.
  - Бюджет  — это сумма, фактически перечисленная Заказчиком Исполнителю исключительно для
    формирования (закупки) ссылочной массы.
  - Технические тексты, изображения и файлы - это тексты, изображения и файлы, права на которые
    принадлежат Исполнителю и размещаются на Web-сайте временно в связи с непредставлением Заказчиком
    своих текстов, изображений и/или файлов. При этом Заказчик не вправе предъявлять Исполнителю
    никаких претензий в связи с размещением указанных файлов, в том числе в связи с их неуникальностью
    и размещении на других сайтах.
...
* 2.2. Предметом настоящего договора является запуск кампании по SEO-продвижению и ежемесячное 
  ...
  - 2.2.1. Запуск кампании представляет из себя анализ сайта заказчика и поисковых запросов и результатом
    такого анализа является разработка стратегии, которая по окончании этого этапа направляется Заказчику
    в формате на электронную почту Заказчика или в мессенджер в виде ссылки или в формате PDF.
...
* 2.4. Заказчик гарантирует наличие необходимых лицензий, сертификатов, государственных регистраций и
  действительность соответствующих документов.

  Заказчик гарантирует наличие необходимых соглашений с правообладателями при необходимости таковых
  в соответствии с действующим законодательством, в том числе в отношении всех размещаемых на Web-сайте
  текстов, изображений и файлов, даже если эти файлы размещены Исполнителем по поручению Заказчика.

  Заказчик с даты подписания им акт приемки-передачи выполненных работ по настоящему договору принимает
  на себя риски предъявления претензий любыми третьими лицами в отношении любых текстов, изображений и
  файлов, размещенных на Web-сайте. С момента приемки-передачи выполненных работ по настоящему договору,
  Заказчик обязуется удостовериться в том, что все тексты, изображения и файлы, размещенные на Web-сайте
  размещены на законных основаниях и Заказчик имеет на руках подтверждение законности их размещения, в том
  числе но не исключительно: авторские договоры, договоры с моделью, договоры купли-продажи изображений,
  лицензии фотостоков и любые иные документы, подтверждающие правомерность использования текстов, изображений и
  любых файлов на Web-сайте. Также Заказчик несет ответственность за контроль соблюдения сроков использования
  текстов, изображений и любых файлов на Web-сайте, если такие сроки установлены подтверждающими документами.
...
* 4.1. По заявке Заказчика Исполнитель передает Заказчику счет на оплату услуг по настройке кампании и
    первый месяц обслуживания по SEO-продвижению сайта Заказчика.

* 4.2. В срок не позднее 3-х рабочих дней с момента поступления денежных средств на расчетный счет
  Исполнителя на основании выставленного счета Исполнитель разрабатывает и направляет Заказчику проект
  Брифа для утверждения основных условий рекламной кампании по SEO-продвижению сайта.

* 4.3. Заказчик согласовывает Бриф в срок не позднее 3-х рабочих дней.

* 4.4. Стоимость и сроки предоставления услуг согласуются Сторонами в счете на предварительную оплату.
  Срок оказания услуг, установленный счетом, начинает течь с момента поступления предварительной оплаты и
  предоставления брифа. Время нахождения результата услуг у Заказчика на согласовании и время устранения
  замечаний Заказчика не засчитывается в срок оказания услуг. В этом случае срок оказания услуг продлевается
  на количество календарных дней, равное периоду с даты направления результата Заказчику до даты получения
  Исполнителем мотивированного ответа Заказчика.

* 4.5. Перечень услуг, оказываемых Исполнителем в рамках запуска кампании по SEO-продвижению сайта Заказчика,
  указан на сайте Исполнителя https://www.synapse-studio.ru/doc/seo-rules.
  
* 4.6. После окончания выполнения работ, указанных в п. 2.2.1 настоящего Договора Исполнитель направляет
  Заказчику список запросов согласно тарифу и документ со стратегией SEO-продвижения сайта. В дальнейшем
  Исполнитель ежемесячно в срок не позднее 5 числа текущего месяца направляет Заказчику план работ на текущий
  месяц. Заказчик вправе представить свои предложения по изменению плана в срок не позднее 3-х календарных дней
  с момента его получения. Не направление Заказчиком в адрес Исполнителя предложений по плану продвижения до
  окончания текущего месяца означает согласие Заказчика с ним.

* 4.7 Исполнитель оказывает Заказчику дополнительные платные услуги по SEO-продвижению сайта Заказчика. Полный
  перечень дополнительных работ по SEO-продвижению сайта размещен на сайте Исполнителя https://www.synapse-studio.ru/doc/seo-rules.
  В случае, если Заказчик изъявляет желание получить какую-либо дополнительную услугу по SEO-продвижению сайта, то
  Исполнитель формирует счет на предварительную оплату выбранных Заказчиком услуг и передает его Заказчику. Стоимость и
  сроки оказания дополнительных услуг согласуются Сторонами в счете на предварительную оплату. Оплата Заказчиком счета
  является подтверждением безусловного согласия Заказчика с условиями оказания дополнительных услуг, их перечнем и стоимостью,
  а также сроком их оказания, указанными в счете на оплату. Срок оказания услуг, установленный счетом, начинает течь с момента
  поступления предварительной оплаты. Срок оказания услуг не включает в себя согласование оказанных услуг с Заказчиком и
  внесение правок на основании замечаний Заказчика.

* 4.8 При наличии заявки Заказчика, направлять ему отчет о рекламной кампании за предыдущий месяц. Отчет направляется не чаще,
  чем один раз в месяц на электронную почту Заказчика или в мессенджер в виде ссылки или в формате PDF.
...
* 5.1. Исполнитель обязан:
  ...
  - 5.1.2. Ежемесячно в срок не позднее 10 числа месяца направлять в адрес Заказчика Акт сдачи-приемки услуг,
    оказанных в предыдущем месяце.
  - 5.1.3. При наличии заявки Заказчика, направлять ему отчет о рекламной кампании за предыдущий месяц. Отчет направляется
    не чаще, чем один раз в месяц на электронную почту Заказчика или в мессенджер в виде ссылки или в формате PDF.
  - 5.1.4. По письменному требованию Заказчика предоставить ему заверенный печатью и подписью экземпляр Договора.
...
* 5.3. Заказчик обязан:
  - 5.3.1.Предоставлять Исполнителю информацию, необходимую для оказания услуг по настоящей Публичной оферте
    в форме заявок по электронной почте, которая привязана к доменному имени synapse-studio.ru или путем направления
  ...
  - 5.3.4. Заказчик гарантирует наличие необходимых соглашений с правообладателями при необходимости таковых
    в соответствии с действующим законодательством, в том числе в отношении всех размещаемых на Web-сайте текстов,
    шрифтов, изображений и файлов, даже если эти файлы размещены Исполнителем по поручению Заказчика.

    Заказчик с даты подписания им акт приемки-передачи выполненных работ по настоящему договору принимает на себя
    риски предъявления претензий любыми третьими лицами в отношении любых текстов, шрифтов, изображений и файлов,
    размещенных на Web-сайте. С момента приемки-передачи выполненных работ по настоящему договору, Заказчик обязуется
    удостовериться в том, что все тексты, шрифты, изображения и файлы, размещенные на Web-сайте размещены на законных
    основаниях и Заказчик имеет на руках подтверждение законности их размещения, в том числе но не исключительно:
    авторские договоры, договоры с моделью, договоры купли-продажи изображений, лицензии фотостоков и любые иные
    документы, подтверждающие правомерность использования текстов, шрифтов, изображений и любых файлов на Web-сайте.
    Также Заказчик несет ответственность за контроль соблюдения сроков использования текстов, шрифтов, изображений и
...
* 6.1. Стоимость услуг по настоящему договору устанавливается Исполнителем в счетах на предварительную оплату. 
  ...
  оферты, перечнем и стоимостью услуг, а также сроком их оказания, указанными в счете на оплату. Стоимость услуг
  по настоящему договору включает в себя НДС 5%. Исполнитель находится на упрощенной системе налогообложения
  и применяет пониженную ставку НДС согласно п. 8 ст. 164 Налогового кодекса Российской Федерации.
...
* 7.1. По окончанию выполнения работ, указанных в п. 4.1. и/или 4.7. настоящего Договора, Исполнитель направляет
  Заказчику акт приемки-передачи оказанных услуг. 
  
* 7.2. В срок не позднее 10-го числа месяца, следующего за отчетным, Исполнитель высылает скан акта приемки-передачи
  оказанных услуг на электронный адрес Заказчика. Также в письме Исполнитель информирует Заказчика о предстоящем направлении
  оригинала акта приемки-передачи оказанных услуг в адрес Заказчика с обязательным указанием адреса, на который будет
  направлен оригинал.
...
* 7.6. В соответствии с Федеральным законом № 229-ФЗ от 27.07.2010 года и Федеральным законом № 63-ФЗ от 06.04.2011 года
  Стороны настоящего Договора соглашаются осуществлять документооборот в электронном виде через СБИС с использованием
  электронной цифровой подписи и признавать юридическую силу всех электронных документов, в том числе счетов-фактур, УПД,
  если на момент формирования электронной цифровой подписи электронного документа сертификат ключа подписи руководителя
  организации, либо иного уполномоченного лица со стороны, направившей документ, является действительным.

  Стороны настоящего Договора соглашаются применять при осуществлении электронного документооборота формы, форматы и порядок,
  установленные действующим законодательством и актами компетентных органов. Стороны настоящего Договора соглашаются применять
  при осуществлении электронного документооборота совместимые технические средства в соответствии с установленными форматами и
  порядком.
  
  В случае обмена актами посредством электронного документооборота, положения п.п. 7.1. – 7.5. действуют в части сроков.


## 8. Срок действия договора

* 8.1. Исполнитель размещает и запускает рекламную кампанию в течение трех рабочих дней с момента согласования Брифа и
...
* 9.2. В случае неисполнения или ненадлежащего исполнения обязанности по оплате оказанных Услуг Заказчик выплачивает Исполнителю
  неустойку из расчета 0,3% за каждый день просрочки от суммы невыполненных обязательств. Выплата неустойки не освобождает
  Заказчика от исполнения обязательства по оплате оказанных услуг.
  
* 9.3. Исполнитель не несет ответственности перед Заказчиком, а также любыми третьими лицами за содержание материалов
  (текстов, изображений и/или файлов), представленных Заказчиком или размещаемых на Web-сайте Исполнителем по согласованию
  с Заказчиком, в том числе Исполнитель не несет ответственности за нарушение авторских и смежных прав третьих лиц.
...
* 9.7. В случае, если спор не урегулирован в претензионном порядке, Стороны настоящего договора передают его на рассмотрение
