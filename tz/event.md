...
- На странице объекта с полной информацией о нем. Для отображения используется шаблон «Событие - типовая страница».
...
- Страница «События» содержит превью созданных материалов. Если на странице более 10 материалов, то страница разбивается на страницы по 10 материалов на странице
...
## Страница События
На странице представлены опубликованные события с сортировкой по дате публикации.
Каждое событие состоит из заголовка, изображения, анонса, даты публикации и тега.
<img src="https://github.com/synapse-studio/helper/blob/master/tz/event/event_1.png">

## Страница Событие
На странице представлено детальное описание события. 
